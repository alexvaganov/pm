...
function addTask(value, isComplete) {
    ...
    var delTask = $('<a href="" title="Удалить" class="del btn btn-danger btn-xs" />').append('<span class="glyphicon glyphicon-remove"></span>');
    var editTask = $('<a href="" title="Редактировать" class="edit btn btn-primary btn-xs" />').append('<span class="glyphicon glyphicon-pencil"></span>');

    if (!value) { // if new task is created
        taskName = $('#taskName').val();
        taskDate = $('#taskDate').val();
        spanDate = $('<span class="date label label-success"/>').text(taskDate);
        ...
        recentLi.appendTo('#recently-added-list');
...
function changeTask() {
    ...
    var spanDate = $('<span class="date label label-success"/>').text(taskDate);
