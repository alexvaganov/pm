<div class="form">
    ...
    <div class="form-group">
        <?php echo CHtml::activeLabelEx($model, 'varname', array('class' => 'col-sm-2 control-label')); ?>
        <div class="col-sm-6">
    ...
    <div class="form-group">
        <?php echo CHtml::activeLabelEx($model, 'title', array('class' => 'col-sm-2 control-label')); ?>
        <div class="col-sm-6">
    ...
    <div class="form-group field_type">
        <?php echo CHtml::activeLabelEx($model, 'field_type',array('class'=>'col-sm-2 control-label')); ?>
        <div class="col-sm-6">
    ...
    <div class="form-group field_size">
        <?php echo CHtml::activeLabelEx($model, 'field_size',array('class'=>'col-sm-2 control-label')); ?>
        <div class="col-sm-6">
    ...
    <div class="form-group field_size_min">
        <?php echo CHtml::activeLabelEx($model, 'field_size_min',array('class'=>'col-sm-2 control-label')); ?>
        <div class="col-sm-6">
    ...
    <div class="form-group required">
        <?php echo CHtml::activeLabelEx($model, 'required',array('class'=>'col-sm-2 control-label')); ?>
        <div class="col-sm-6">
    ...
    <div class="form-group match">
        <?php echo CHtml::activeLabelEx($model, 'match',array('class'=>'col-sm-2 control-label')); ?>
        <div class="col-sm-6">
    ...
    <div class="form-group range">
        <?php echo CHtml::activeLabelEx($model, 'range',array('class'=>'col-sm-2 control-label')); ?>
        <div class="col-sm-6">
    ...
    <div class="form-group error_message">
        <?php echo CHtml::activeLabelEx($model, 'error_message',array('class'=>'col-sm-2 control-label')); ?>
        <div class="col-sm-6">
    ...
    <div class="form-group other_validator">
        <?php echo CHtml::activeLabelEx($model, 'other_validator',array('class'=>'col-sm-2 control-label')); ?>
        <div class="col-sm-6">
    ...
    <div class="form-group default">
        <?php echo CHtml::activeLabelEx($model, 'default',array('class'=>'col-sm-2 control-label')); ?>
        <div class="col-sm-6">
    ...
    <div class="form-group widget">
        <?php echo CHtml::activeLabelEx($model, 'widget',array('class'=>'col-sm-2 control-label')); ?>
        <div class="col-sm-6">
            <?php
    ...
    <div class="form-group widgetparams">
        <?php echo CHtml::activeLabelEx($model, 'widgetparams',array('class'=>'col-sm-2 control-label')); ?>
        <div class="col-sm-6">
    ...
    <div class="form-group position">
        <?php echo CHtml::activeLabelEx($model, 'position',array('class'=>'col-sm-2 control-label')); ?>
        <div class="col-sm-6">
    ...
    <div class="form-group visible">
        <?php echo CHtml::activeLabelEx($model, 'visible',array('class'=>'col-sm-2 control-label')); ?>
        <div class="col-sm-6">
